...
Compaction reduces context size by replacing historical content with a summary. 1. Select a portion of historical items (older turns) 2. Construct a summarization prompt 3. Invoke the model to generate a summary 4. Replace selected history with the summary
